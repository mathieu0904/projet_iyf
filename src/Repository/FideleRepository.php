...
/**
 * @extends ServiceEntityRepository<Fidele>
 *
...
class FideleRepository extends ServiceEntityRepository
{
    ...
    public function save(Fidele $entity, bool $flush = false): void
    {
...
//    /**
//     * @return Fidele[] Returns an array of Fidele objects
//     */
...
//    public function findOneBySomeField($value): ?Fidele
//    {
//        return $this->createQueryBuilder('f')
//            ->andWhere('f.exampleField = :val')
//            ->setParameter('val', $value)
